    ...
    <section className="relative bg-white py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <Badge className="mb-6 bg-indigo-100 text-indigo-800 hover:bg-indigo-100">🚀 Join 10,000+ skill swappers worldwide</Badge>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="#features">
              <Button variant="light" className="outline-1 outline-gray-300 shadow-md text-lg font-semibold px-6 py-2">Browse Skills</Button>
            </Link>
          </div>
        </div>
      </div>
